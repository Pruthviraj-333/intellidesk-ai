...
class TestUpdateIncident:
    ...
    def test_update_incident_status(self, client, auth_headers_manager):
        ...
        resp = client.put(f"/api/v1/incidents/{incident_id}",
    ...
    def test_add_timeline_entry(self, client, auth_headers_agent):
        ...
        resp = client.post(f"/api/v1/incidents/{incident_id}/timeline", json={
            "event_type": "update",
...
class TestProblems:
    ...
    def test_update_problem_root_cause(self, client, auth_headers_manager):
        ...
        create_resp = client.post("/api/v1/problems/", json={
        ...
        resp = client.put(f"/api/v1/problems/{problem_id}", json={

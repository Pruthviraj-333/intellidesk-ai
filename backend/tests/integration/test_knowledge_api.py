...
class TestCreateArticle:
    ...
    def test_agent_can_create_draft_article(self, client, auth_headers_agent):
        resp = client.post("/api/v1/knowledge/articles", json={
            "title": "How to reset your VPN configuration",
            "body": "This article explains the step-by-step process for resetting your VPN. " * 10,
...
class TestGetArticle:
    ...
    def test_get_nonexistent_article(self, client, auth_headers_agent):
        resp = client.get("/api/v1/knowledge/articles/nonexistent-slug-xyz", headers=auth_headers_agent)
...
class TestUpdateArticle:
    ...
    def test_agent_can_update_own_article(self, client, auth_headers_agent):
        ...
        resp = client.put(f"/api/v1/knowledge/articles/{article_id}", json={
...
class TestArticleVoting:
    ...
    def _get_published_article_id(self, client, agent_headers, manager_headers):
        create_resp = client.post("/api/v1/knowledge/articles", json={
    ...
    def test_vote_helpful(self, client, auth_headers_employee, auth_headers_agent, auth_headers_manager):
        article_id = self._get_published_article_id(client, auth_headers_agent, auth_headers_manager)
        resp = client.post(
...
class TestCategories:
    ...
    def test_admin_creates_category(self, client, auth_headers_admin):
        resp = client.post("/api/v1/knowledge/categories", json={
